...
extern "C" void asmLoad16bRGBA (int src, int dst, int wid_64, int height, int line, int ext);
extern "C" void asmLoad16bIA (int src, int dst, int wid_64, int height, int line, int ext);
...
wxUint32 Load16bRGBA (wxUint32 dst, wxUint32 src, int wid_64, int height, int line, int real_width, int tile)
{
...
wxUint32 Load16bIA (wxUint32 dst, wxUint32 src, int wid_64, int height, int line, int real_width, int tile)
{
  if (wid_64 < 1) wid_64 = 1;
  if (height < 1) height = 1;
  int ext = (real_width - (wid_64 << 2)) << 1;
...
wxUint32 Load16bYUV (wxUint32 dst, wxUint32 src, int wid_64, int height, int line, int real_width, int tile)
{
